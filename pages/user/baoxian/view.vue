	...
	<view>
		<uni-forms ref="valiForm" :rules="rules" :modelValue="formData" label-width="240rpx" border>
			<uni-group margin-top="20">
				...
				<uni-forms-item label="投保企业类型" name="shenfen">
					<view class="form-select">
						<picker @change="bindPickerChange" :value="index" range-key="text" :range="shenfens">
							<view class="uni-input">{{showType}}</view>
						</picker>
			...
			<uni-group>
				...
				<uni-forms-item label="活动名称" name="nickname" label-width="80">
					<uni-easyinput v-model="formData.nickname" placeholder="投保企业名称" :clearable="false" :inputBorder="false" />
				</uni-forms-item>
				...
				<uni-forms-item label="保险期间" name="shenfen">
					<uni-data-checkbox v-model="formData.shenfen" :localdata="shenfens"></uni-data-checkbox>
				</uni-forms-item>
			</uni-group>
			<lun-gap height="20" bgColor="#f8f8f9"></lun-gap>
			<uni-group>
				...
				<uni-forms-item label="面积(平米)" name="shenfen">
					<uni-data-checkbox v-model="formData.shenfen" :localdata="shenfens"></uni-data-checkbox>
				</uni-forms-item>
				<uni-forms-item label="搭建商名称" name="shenfen">
					<uni-data-checkbox v-model="formData.shenfen" :localdata="shenfens"></uni-data-checkbox>
				</uni-forms-item>
			</uni-group>
			<uni-group>
