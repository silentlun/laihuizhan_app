				...
				<slot name="header">
					<view class="uni-list-item__header">
						...
						<view v-else-if="showExtraIcon" class="uni-list-item__icon">
							<t-icons :color="extraIcon.color" :size="extraIcon.size" :type="extraIcon.type" />
						</view>
					</view>
				</slot>
				<slot name="body">
					<view class="uni-list-item__content"
						...
						<text v-if="subtitle" class="uni-list-item__content-subtitle"
							:class="[ellipsis !== 0 && ellipsis <= 2 ? 'uni-ellipsis-' + ellipsis : '']">{{ subtitle }}</text>
				...
				<slot name="footer">
					<view v-if="rightText || showBadge || showSwitch" class="uni-list-item__extra"
						...
						<switch v-if="showSwitch" :disabled="disabled" :checked="switchChecked"
							@change="onSwitchChange" style="transform: scale(0.8)" />
					</view>
				</slot>
			</view>
			<t-icons v-if="showArrow || link" :size="16" class="uni-icon-wrapper" color="#bbb" type="right" />
		</view>
		<!-- #ifdef APP-NVUE -->
	</cell>
	<!-- #endif -->
...
<style lang="scss" scoped>
	$list-item-pd: $uni-spacing-col-base $uni-spacing-row-base;
