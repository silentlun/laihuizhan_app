		...
		'uni-date-x--border': border}">
					<view v-if="!isRange" class="uni-date-x uni-date-single">
						...
						<input class="uni-date__x-input" type="text" v-model="singleVal"
							:placeholder="singlePlaceholderText" placeholder-class="uni-date__placeholder-class" :disabled="true" />
					</view>
					<view v-else class="uni-date-x uni-date-range">
						<uni-icons type="calendar" color="#c0c4cc" size="22"></uni-icons>
						<input class="uni-date__x-input t-c" type="text" v-model="range.startDate"
							:placeholder="startPlaceholderText" placeholder-class="uni-date__placeholder-class" :disabled="true" />
						<slot>
							<view class="">{{rangeSeparator}}</view>
						</slot>
						<input class="uni-date__x-input t-c" type="text" v-model="range.endDate"
							:placeholder="endPlaceholderText" placeholder-class="uni-date__placeholder-class" :disabled="true" />
					</view>
